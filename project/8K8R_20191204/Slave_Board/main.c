...
void Key2_Fun(void)
{
	switch(Gu8Step)
	{
		...
		case 1:
			...
			Nmos_Set(0,3);
			Nmos_Set(0,4);//第1-5位灭
			if(LED_TIME_7S<=vGu16TimeCnt_1) //7s时间到
				Gu8Step++;
			break;
		case 2:
			Nmos_Set(1,4);//第5位亮
			if(LED_TIME_10S<=vGu16TimeCnt_1) //10s时间到
				Gu8Step++;		
			break;	
		case 3:
			Nmos_Set(0,4);//第5位灭
			if(LED_TIME_15S<=vGu16TimeCnt_1) //15s时间到
				Gu8Step++;
			break;
		case 4:
			Nmos_Set(1,3);//第4位亮
			if(LED_TIME_18S<=vGu16TimeCnt_1) //18s时间到
				Gu8Step++;
			break;
		case 5:
			Nmos_Set(0,3);//第4位灭
			if(LED_TIME_23S<=vGu16TimeCnt_1) //23s时间到
				Gu8Step++;
			break;
		case 6:
			Nmos_Set(1,2);//第3位亮
			if(LED_TIME_26S<=vGu16TimeCnt_1) //26s时间到
				Gu8Step++;
			break;
		case 7:
			Nmos_Set(0,2);//第3位灭
			if(LED_TIME_31S<=vGu16TimeCnt_1) //31s时间到
				Gu8Step++;
			break;
		case 8:
			Nmos_Set(1,1);//第2位亮
			if(LED_TIME_34S<=vGu16TimeCnt_1) //34s时间到
				Gu8Step++;
			break;
		case 9:
			Nmos_Set(0,1);//第2位灭
			if(LED_TIME_39S<=vGu16TimeCnt_1) //39s时间到
				Gu8Step++;
			break;
		case 10:
			Nmos_Set(1,0);//第1位亮
			if(LED_TIME_42S<=vGu16TimeCnt_1) //39s时间到
				Gu8Step++;
			break;
		case 11:
			Nmos_Set(0,0);//第1位灭
...
void Key3_Fun(void)
{
	switch(Gu8Step)
	{
		...
		case 8:
			Nmos_Set(1,0);//第1位亮
			if(LED_TIME_42S<=vGu16TimeCnt_1) //42s时间到
				Gu8Step++;
			break;
		case 9:
			Nmos_Set(0,0);//第1位灭
...
void Key4_Fun(void)
{
	switch(Gu8Step)
	{
		...
		case 4:
			Nmos_Set(1,1);//第2位亮
			if(LED_TIME_34S<=vGu16TimeCnt_1) //31s时间到
				Gu8Step++;
			break;
		case 5:
			Nmos_Set(0,1);//第2位亮
			if(LED_TIME_39S<=vGu16TimeCnt_1) //34s时间到
				Gu8Step++;
			break;
		case 6:
			Nmos_Set(1,0);//第2位亮
